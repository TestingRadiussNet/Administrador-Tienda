  ...
  return (
    <form onSubmit={IniciarSesion}>
      ...
      <div className="flex gap-x-2 items-center mx-auto my-2">
        ...
        <input value={correo} onInput={(ev: any) => setCorreo(ev.target.value)} type="text" placeholder="Usuario" className=" border-b-2 border-b-red-700 rounded-sm font-spacemono text-xl"/>
      </div>
